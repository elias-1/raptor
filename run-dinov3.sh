...
python create_projector.py --seed 0 --d 1024 --k 100 --saveas data/proj_normal_d1024_k100_run2

python -u new_embed.py --folder /fs/ess/PCON0023/eye3d/data/ukbiobank/oct \
    --encoder DINOv3 \
    --batch_size 1296 \
    --saveto dinov3_processed_data \
    --k data/proj_normal_d1024_k100_run2.npy