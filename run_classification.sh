...
# Set job name
#SBATCH --job-name=multilabel_classification-dinov2
...
#SBATCH --output=multilabel_classification-dinov2/%j_0_log.out

#SBATCH --error=multilabel_classification-dinov2/%j_0_log.err
...
python multilabel_classification.py \
    ...
    --data_path dinov2_processed_data/proj_normal_d1024_k100_run1
